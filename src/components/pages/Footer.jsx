  ...
  return (
    ...
    >
      <div className="container">
        <div className="row text-center text-md-start">
          ...
          <div className="col-md-4 mb-4">
            <div className="d-flex align-items-center justify-content-center justify-content-md-start mb-2">
              ...
              />
              <h4 className="mb-0 fw-bold" style={{ letterSpacing: 1 }}>TravelPlanner</h4>
            </div>
            <div className="d-flex justify-content-center align-items-center gap-4 mt-4 flex-wrap">
              ...
              >
                <img
                  ...
                  alt="Google Play"
                  style={{ height: "48px", borderRadius: 8, boxShadow: "0 1px 4px rgba(0,0,0,0.07)" }}
                />
              </a>
              <a
          ...
          {/* Get Started */}
          <div className="col-md-4 mb-4">
            <h6 className="fw-bold mb-3 text-primary" style={{ letterSpacing: 1 }}>Get started</h6>
          ...
          {/* Resources */}
          <div className="col-md-4 mb-4">
            <h6 className="fw-bold mb-3 text-primary" style={{ letterSpacing: 1 }}>Resources</h6>
            <ul className="list-unstyled">
                ...
                <li className="mb-2" key={idx}>
                  {link.external ? (
                    <a
                      ...
                      className="text-secondary"
                      style={{
                        textDecoration: hovered[link.label] ? "underline" : "none",
        ...
        <div className="d-flex justify-content-between align-items-center flex-wrap mt-4 py-3 px-2" style={{ background: "rgba(255,255,255,0.7)", borderRadius: 16 }}>
          {/* Social */}
          <div>
            <h6 className="mb-2" style={{ fontWeight: 600 }}>Follow us</h6>
            <a href="#" className="me-2" style={{ color: "#4267B2", transition: "transform 0.2s" }}
              onMouseEnter={e => e.currentTarget.style.transform = "scale(1.15)"}
              onMouseLeave={e => e.currentTarget.style.transform = "scale(1)"}
            >
              <i className="bi bi-facebook fs-4"></i>
            </a>
            <a href="#" className="me-2" style={{ color: "#1DA1F2", transition: "transform 0.2s" }}
              onMouseEnter={e => e.currentTarget.style.transform = "scale(1.15)"}
              onMouseLeave={e => e.currentTarget.style.transform = "scale(1)"}
            >
              <i className="bi bi-twitter fs-4"></i>
            </a>
            <a href="#" style={{ color: "#C13584", transition: "transform 0.2s" }}
              onMouseEnter={e => e.currentTarget.style.transform = "scale(1.15)"}
              onMouseLeave={e => e.currentTarget.style.transform = "scale(1)"}
            >
          ...
          <div className="text-center">
            <h6 className="mb-2" style={{ fontWeight: 600 }}>We Accept</h6>
            <img
              src="https://cdn.visa.com/v2/assets/images/logos/visa/blue/logo.png"
              alt="Visa"
              style={{ maxHeight: "36px", margin: "0 8px", filter: "grayscale(30%)" }}
            />
            <img
          ...
          <div className="text-end">
            <h6 className="mb-2" style={{ fontWeight: 600 }}>Member of</h6>
            <img
        ...
        {/* Bottom Text */}
        <div className="text-center text-muted mt-4" style={{ fontSize: "1rem", letterSpacing: 0.5 }}>
          © 2025 <span style={{ color: "#6366f1", fontWeight: 600 }}>TravelPlanner</span>. A product of <span style={{ color: "#6366f1", fontWeight: 600 }}>ExcelRTech LTD</span>.
        </div>
      </div>
    </footer>
  );
