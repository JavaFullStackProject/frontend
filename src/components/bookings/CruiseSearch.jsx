...
//       // Assuming the response is a plain array of cruises
//       const filteredCruises = response.data?.filter((voyage) => {
...
//         const matchDate = date ? voyage.departureDate?.startsWith(date) : true;
...
//                       {cruise.destination || "Unknown Destination"}
//                     </h5>
//                     <p className="card-text">
//                       Ship: {cruise.shipName || "N/A"} <br />
//                       Departure: {cruise.departureDate || "TBD"} <br />
//                       Duration: {cruise.duration || "Unknown"} days
//                     </p>
//                   </div>
//                 </div>
//               </div>
